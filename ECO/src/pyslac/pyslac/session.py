...
class SlacEvseSession(SlacSession):
    ...
    async def evse_set_key(self) -> bytes:
        ...
        try:
            ...
            # Allow slac.env to override the initial wait for CNF
            init_to = self.config.slac_init_timeout or Timers.SLAC_INIT_TIMEOUT
        ...
        while True:
            try:
                ...
                data_rcvd = await self.rcv_frame(
                    ...
                    timeout=(self.config.slac_req_timeout or Timers.SLAC_REQ_TIMEOUT),
                )
